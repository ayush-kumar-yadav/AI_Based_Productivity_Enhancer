    ...
    <>
      <style>{`
        ...
        .lr-btn {
          ...
          box-shadow: 0 4px 16px rgba(59,114,246,0.30); margin-top: 2px;
        }
      ...
      {/* doodle-bg class is defined in index.css */}
      <div className="doodle-bg lr-root">
        <div className="lr-card">
          ...
          <p className="lr-sub">Login to continue managing your tasks.</p>
          ...
          <form onSubmit={handleLogin}>
            ...
            <button type="submit" className="lr-btn">Login</button>
          </form>

          <p className="lr-footer">
            Don't have an account?{" "}
            <span className="lr-link" onClick={() => navigate("/register")}>Sign Up</span>
          </p>
        </div>
